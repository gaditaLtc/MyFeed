...
// El metodo doGet() se ejecuta una vez por cada petición HTTP GET.
	@Override
...
//URL de la base de datos(equipo, puerto, base de datos)
			String url = "jdbc:mysql://localhost/Despliegue";
			conn = DriverManager.getConnection(url, userName, password);
// Paso 3: Crear sentencias SQL, utilizando objetos de tipo Statement
			stmt = conn.createStatement();
// Paso 4: Ejecutar las sentencias SQL a trav_es de los objetos Statement
			String sqlStr = "select * from libros where autor = " + "'" + request.getParameter("autor") + "'";
// Generar una p_agina HTML como resultado de la consulta
